#ifndef __CLOUD_STORAGE_TCP_CONNECTION_HPP__
#define __CLOUD_STORAGE_TCP_CONNECTION_HPP__
...
public:
  ...
  void send(const FKString &message);
...
private:
  ...
  void handleRead(date::TimeStamp receiveTime);
  void handleWrite();
  void handleClose();
  void handleError();
  void sendInLoop(const FKString &message);
